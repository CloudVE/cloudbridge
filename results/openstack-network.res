...
==============================================================
  ...
  1319         2          4.0      2.0      0.0          if isinstance(fip, OpenStackFloatingIP):
  1320                                                       # pylint:disable=protected-access
  1321                                                       os_ip = fip._ip
  1322                                                   else:
  1323         2          1.0      0.5      0.0              try:
  1324         2     684604.0 342302.0     29.2                  os_ip = self.provider.os_conn.network.get_ip(fip)
  1325                                                       except (ResourceNotFound, NotFoundException):
  1326                                                           log.debug("Floating IP %s not found.", fip)
  1327                                                           return True
  1328         2    1662022.0 831011.0     70.8          os_ip.delete(self._provider.os_conn.session)
